...
# adpcm encode
#gem5.opt -d adpcm/encode_small ../configs/example/se.py -c adpcm/bin/rawcaudio -i adpcm/data/small.pcm --output=adpcm/output_small.adpcm
#gem5.opt -d adpcm/encode_large ../configs/example/se.py -c adpcm/bin/rawcaudio -i adpcm/data/large.pcm --output=adpcm/output_large.adpcm

# adpcm decode
#gem5.opt -d adpcm/decode_small ../configs/example/se.py -c adpcm/bin/rawdaudio -i adpcm/data/small.adpcm --output=adpcm/output_small.pcm
